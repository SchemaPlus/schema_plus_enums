...
* ruby **2.2.10** with activerecord **4.2**, using **postgresql**
* ruby **2.2.10** with activerecord **5.0**, using **postgresql**
* ruby **2.2.10** with activerecord **5.1**, using **postgresql**
* ruby **2.2.10** with activerecord **5.2**, using **postgresql**
* ruby **2.3.7** with activerecord **4.2**, using **postgresql**
* ruby **2.3.7** with activerecord **5.0**, using **postgresql**
* ruby **2.3.7** with activerecord **5.1**, using **postgresql**
* ruby **2.3.7** with activerecord **5.2**, using **postgresql**
* ruby **2.4.4** with activerecord **4.2**, using **postgresql**
* ruby **2.4.4** with activerecord **5.0**, using **postgresql**
* ruby **2.4.4** with activerecord **5.1**, using **postgresql**
* ruby **2.4.4** with activerecord **5.2**, using **postgresql**
* ruby **2.5.1** with activerecord **4.2**, using **postgresql**
* ruby **2.5.1** with activerecord **5.0**, using **postgresql**
* ruby **2.5.1** with activerecord **5.1**, using **postgresql**
* ruby **2.5.1** with activerecord **5.2**, using **postgresql**
